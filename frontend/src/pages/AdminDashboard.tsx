...
import {
  ...
  FileText, FileSpreadsheet, Table, Copy, Minus, AlertTriangle, Bot
} from 'lucide-react';
import {
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    if (activeTab === 'bot-settings') fetchBotSettings();
  }, [activeTab]);
  ...
  const tabs = [
    ...
    ...(user?.role === 'admin' ? [
      ...
      { id: 'bot-settings', label: 'Bot Settings', icon: Bot, badge: undefined },
    ] : []),
  ];
...
<tbody>
            ...
            {/* ── BOT SETTINGS ── */}
            {activeTab === 'bot-settings' && user?.role === 'admin' && (
              <div className="max-w-3xl">
                      ...
                      <CardContent className="p-5">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-1.5">
                            ...
                            />
                            <p className="text-[10px] text-muted-foreground">
                              Format: minute hour day month weekday. Examples: "0 9 * * *" = daily at 9 AM, "0 9,18 * * *" = 9 AM and 6 PM
                            </p>
                          </div>
