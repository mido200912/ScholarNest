          ...
          <div className="bg-card border border-border rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={handleUpdateScholarship} className="p-5 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Input label="Title (EN)" value={editingScholarship.title?.en || ''} onChange={e => setEditingScholarship({ ...editingScholarship, title: { ...editingScholarship.title, en: e.target.value } })} required />
                <Input label="Title (AR)" value={editingScholarship.title?.ar || ''} onChange={e => setEditingScholarship({ ...editingScholarship, title: { ...editingScholarship.title, ar: e.target.value } })} required dir="rtl" />
                <Input label="University (EN)" value={editingScholarship.university?.en || ''} onChange={e => setEditingScholarship({ ...editingScholarship, university: { ...editingScholarship.university, en: e.target.value } })} required />
                <Input label="University (AR)" value={editingScholarship.university?.ar || ''} onChange={e => setEditingScholarship({ ...editingScholarship, university: { ...editingScholarship.university, ar: e.target.value } })} required dir="rtl" />
                <Input label="Country (EN)" value={editingScholarship.country?.en || ''} onChange={e => setEditingScholarship({ ...editingScholarship, country: { ...editingScholarship.country, en: e.target.value } })} required />
                <Input label="Country (AR)" value={editingScholarship.country?.ar || ''} onChange={e => setEditingScholarship({ ...editingScholarship, country: { ...editingScholarship.country, ar: e.target.value } })} required dir="rtl" />
                <div className="space-y-1.5"><Label className="text-xs">Degree</Label>
                ...
                <Input label="Deadline" type="date" value={editingScholarship.deadline?.substring(0, 10) || ''} onChange={e => setEditingScholarship({ ...editingScholarship, deadline: e.target.value })} required />
                <Input label="Application Link" value={editingScholarship.link || ''} onChange={e => setEditingScholarship({ ...editingScholarship, link: e.target.value })} required />
              </div>
              <Input label="Description (EN)" value={editingScholarship.description?.en || ''} onChange={e => setEditingScholarship({ ...editingScholarship, description: { ...editingScholarship.description, en: e.target.value } })} required />
              <Input label="Description (AR)" value={editingScholarship.description?.ar || ''} onChange={e => setEditingScholarship({ ...editingScholarship, description: { ...editingScholarship.description, ar: e.target.value } })} required dir="rtl" />
              <Input label="Image URL (optional)" value={editingScholarship.image || ''} onChange={e => setEditingScholarship({ ...editingScholarship, image: e.target.value })} />
